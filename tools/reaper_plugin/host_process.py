    ...
    for hwnd in tops:
        ...
        for c in controls:
            ...
            if choose:
                ...
                u.PostMessageW(c['handle'],0x00f5,0,0) # BM_CLICK, normal UI button
    if observed:
    ...
    with (case/'console.txt').open('wb') as out:
        ...
        while p.poll() is None:
            ...
            if int(age)!=last_poll:
                ...
                if os.name=='nt' and not script_started and age>=1:
                    try: windows_startup(p.pid,case,age)
                    except Exception as e:
                        print('STARTUP_DIAGNOSTIC_ERROR',repr(e),flush=True)
                if age>=timeout:
