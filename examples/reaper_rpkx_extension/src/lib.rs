...
/// Spectral/spectrogram analysis remains capped until its DSP is incremental.
#[no_mangle]
...
/// Ordinary PCM16 waveform mode from incrementally decoded fine-bucket extrema.
/// pair_count is total interleaved channel pairs, not the number of time buckets.
#[no_mangle]
pub unsafe extern "C" fn lrpk_generate_wave_pcm16(
    pairs:*const stream_wave::I16Extrema,
    pair_count:usize,
    frames:usize,
    channels:u32,
    rate:u32,
