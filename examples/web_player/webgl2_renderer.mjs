...
export class WebGL2PackedRenderer {
  constructor(canvas, meta, {pageRecords = PAGE_RECORDS} = {}) {
    this.canvas = canvas;
    this.meta = meta;
  ...
  paint(params) {
    ...
    this.setWindowUniforms('Wave', 'wave', this.uploads.get('waveform'), params.viewStart, params.viewEnd);
    this.setWindowUniforms('Spectral', 's', params.showSpectral ? this.uploads.get('spectral') : null, params.viewStart, params.viewEnd);
    this.setWindowUniforms('G', 'g', this.uploads.get('spectrogram'), params.viewStart, params.viewEnd);
    this.setWindowUniforms('Loudness', 'r', params.showLoudness ? this.uploads.get('loudness') : null, params.viewStart, params.viewEnd);
  ...
  async render(params) {
    ...
    this.resize();
    const desired = Math.max(1, (params.viewEnd - params.viewStart) / Math.max(1, this.canvas.clientWidth));
